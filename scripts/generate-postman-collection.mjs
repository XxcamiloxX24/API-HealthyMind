...
const folders = [
  ...
  },
  {
    ...
    item: [
      ...
      req("GET", "/api/Aprendiz/estadistica/por-mes/2025", "estadistica por-mes (por año en ruta)"),
      req("GET", "/api/Aprendiz/estadistica/por-mes", "estadistica por-mes (query ?anio=)", { query: "anio=2025" }),
      req("GET", "/api/Aprendiz/estadistica/anios-registro-aprendices", "estadistica anios-registro-aprendices"),
  ...
  {
    name: "Informes (estadísticas agregadas)",
    item: [
      req("GET", "/api/Informes/resumen-general", "Resumen general (KPIs)"),
      req("GET", "/api/Informes/citas-por-centro", "Citas por centro"),
      req("GET", "/api/Informes/citas-por-centro?desde=2025-01-01&hasta=2025-12-31", "Citas por centro (rango)"),
      req("GET", "/api/Informes/citas-por-regional", "Citas por regional"),
      req("GET", "/api/Informes/citas-por-psicologo", "Citas por psicólogo"),
      req("GET", "/api/Informes/tasa-asistencia-por-centro", "Tasa asistencia por centro"),
      req("GET", "/api/Informes/aprendices-por-regional", "Aprendices por regional"),
      req("GET", "/api/Informes/aprendices-por-programa", "Aprendices por programa"),
      req("GET", "/api/Informes/aprendices-por-area", "Aprendices por área"),
      req("GET", "/api/Informes/aprendices-por-nivel", "Aprendices por nivel"),
      req("GET", "/api/Informes/programas-por-centro", "Programas y fichas por centro"),
      req("GET", "/api/Informes/seguimientos-por-estado", "Seguimientos por estado"),
      req("GET", "/api/Informes/seguimientos-por-centro", "Seguimientos por centro"),
      req("GET", "/api/Informes/seguimientos-por-programa", "Seguimientos por programa"),
      req("GET", "/api/Informes/tests-por-programa", "Tests por programa"),
      req("GET", "/api/Informes/reportes-por-periodo", "Reportes por período"),
    ],
  },
];
